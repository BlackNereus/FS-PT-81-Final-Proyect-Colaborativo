			...
			<div className="container-fluid">
				<div className="row">
					<div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 d-flex justify-content-center card_container">
						<div className="card">
							<img src="https://sanicur.es/wp-content/uploads/2023/11/14.jpg" className="card-img-top" alt="DRACLARAFUENTES" />
							...
							<div className="card-body">
								...
								<hr className="lineas" />
								<p>Nuestro equipo de especialistas en medicina general ofrece una atención integral,
									abordando de forma interdisciplinaria los aspectos físicos, emocionales y sociales de cada paciente,
									garantizando tu bienestar en todas las etapas de la vida.</p>
							</div>
						</div>
					</div>
					<div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 d-flex justify-content-center card_container">
